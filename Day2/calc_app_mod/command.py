from calc_app_mod.console_input import (
    console_str_input, console_int_input, console_float_input
)
from calc_app_mod.console_output import (
...
from calc_app_mod.history import (
    append_history_entry, remove_history_entry, clear_history_entries,
    calc_result
)
...
def command_clear():
    ...
    console_result_output(calc_result(history))

def command_calc(command_name):
    operand = console_float_input("Please enter an operand: ")
    append_history_entry(history, command_name, operand)
    console_result_output(calc_result(history))
